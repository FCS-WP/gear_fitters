...
Kirki::add_panel( 'panel_api', array(
    'title'         => esc_html__( 'API keys', 'sportie' ),
    'priority'      => 25,
) );
...
Kirki::add_section( 'mailchimp_api', array(
    'title'          => esc_html__( 'Mailchimp API', 'sportie' ),
    'priority'       => 65,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_api'
) );
Kirki::add_section( 'google_api', array(
    'title'          => esc_html__( 'Google API', 'sportie' ),
    'priority'       => 66,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_api'
) );
Kirki::add_section( 'instagram_access_token', array(
    'title'          => esc_html__( 'Instagram Access Token', 'sportie' ),
    'priority'       => 67,
    'capability'     => 'edit_theme_options',
    'panel'          => 'panel_api'
) );
...
Kirki::add_field( 'sportie', array(
    ...
    'label'       => esc_html__( 'Instagram Access Token', 'sportie' ),
...
Kirki::add_field( 'sportie', array(
    ...
    'label'       => esc_html__( 'MailChimp API key', 'sportie' ),
    'section'     => $section,
...
Kirki::add_field( 'sportie', array(
    ...
    'label'       => esc_html__( 'MailChimp list ID', 'sportie' ),
    'section'     => $section,
...
Kirki::add_field( 'sportie', array(
    ...
    'label'       => esc_html__( 'Double opt-in', 'sportie' ),
    'section'     => $section,
    'default'     => false,
...
Kirki::add_field( 'sportie', array(
    ...
    'label'       => esc_html__( 'Google maps API key', 'sportie' ),
    'section'     => 'google_api',
    'default'     => '',
    'priority'    => 10,
) );
