	...
	class Nova_OP {
		...
		private static function theme_defaults() {
			return [
				...
				'popup_show_again_text' 			=> esc_html__( 'Don’t show this popup again', 'sportie' ),
				...
				'pager_header_background_color' => '#E5E9DD',
				...
				'secondary_font' 						=> array('font-family' => 'Poppins', 'variant' => '600', 'subsets' => array('latin')),
				...
				'site_link_hover_color'				=> '#4D592E',
				'primary_button_color'				=> '#242424',
				'secondary_button_color'			=> '#4D592E',
				...
				'sale_page_title'                   	=> esc_html__( 'On Sale!', 'sportie' ),
				'sale_page_badge_text'              	=> esc_html__( 'Sale!', 'sportie' ),
				'new_products_page'                 	=> true,
				'new_products_page_slug'            	=> 'new-products',
				'new_products_page_title'           	=> esc_html__( 'New Products', 'sportie' ),
				'new_products_badge_text'           	=> esc_html__( 'New!', 'sportie' ),
				...
				// Footer
				'footer_template'							=> 'type-builder',
				'footer_template_builder'				=> '1561',
				'footer_background_color' 		=> '#000',
				'footer_font_color' 					=> '#fff',
				'footer_headings_color'             	=> '#fff',
				'footer_text' 							=> esc_html__( '© 2021 Sportie All rights reserved. Designed by Novaworks', 'sportie' ),
				...
				'facebook_link' 						=> '#',
				'twitter_link' 							=> '#',
				'nav_button_title'						=> esc_html__( 'Browse Categories', 'sportie' ),
