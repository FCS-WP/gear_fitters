      ...
      elementor.hooks.addAction('frontend/element_ready/widget', function ($scope) {
        ...
        elementor.hooks.addAction('frontend/element_ready/novaworks-tabs.default', function ($scope) {
            ...
            function switchTab(curentIndex) {
                ...
                $(document.body).on('loaded_tab_content', function() {
                      $.LoadingOverlay("hide");
                });
                ...
                var $el = $activeContent.find( '.js-el' );
                $el.data('init-AdvancedMasonry', false);

                setTimeout(function() {
                  Novaworks.core.initAll($activeContent);
                }, 200);
                ...
                setTimeout(function() {
                  $(document.body).trigger('loaded_tab_content');
                }, 500);
            }
