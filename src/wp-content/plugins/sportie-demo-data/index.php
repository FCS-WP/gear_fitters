<?php
/*
Plugin Name:    Sportie Package Demo Data
...
class Sportie_Data_Demo_Plugin_Class{
    ...
    public static $theme_name = 'sportie';

    public static $demo_site = 'https://sportie.novaworks.net/';
...
add_action('plugins_loaded', function(){
    ...
    if(strtolower($theme->get_template()) != 'sportie'){

        add_action( 'admin_notices', function(){
            printf( __( '%1$s"Sportie Package Demo Data" requires %3$s"Sportie"%4$s theme to be installed and activated. Please active %3$s"Sportie"%4$s to continue.%2$s', 'novaworks-demodata' ), '<div class="error"><p>', '</p></div>' ,'<strong>', '</strong>' );
        });
    ...
    Sportie_Data_Demo_Plugin_Class::get_instance();
}, 999);
