 ...
 */
class Subscribe_Form extends NOVA_Widget_Base {
    ...
    public function get_name() {
        return 'novaworks-subscribe-form';
    }

    protected function get_widget_title() {
        return esc_html__( 'Subscribe', 'novaworks' );
    }

    public function get_icon() {
        return 'nova-elements-icon-35';
    }
    ...
    protected function register_controls() {
        ...
        $css_scheme = apply_filters(
            'NovaworksElement/subscribe-form/css-scheme',
            array(
                'instance'    => '.novaworks-subscribe-form',
                'input'       => '.novaworks-subscribe-form__input',
                'submit'      => '.novaworks-subscribe-form__submit',
                'submit_icon' => '.novaworks-subscribe-form__submit-icon',
                'message'     => '.novaworks-subscribe-form__message',
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label' => esc_html__( 'Fields', 'novaworks' ),
            )
        );
        ...
        $this->add_control(
            'submit_button_text',
            array(
                'label'       => esc_html__( 'Submit Text', 'novaworks' ),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Enter Submit Button Text', 'novaworks' ),
                'default'     => esc_html__( 'Subscribe', 'novaworks' ),
            )
        );
        ...
        $this->add_control(
            'submit_placeholder',
            array(
                'label'       => esc_html__( 'Input Placeholder', 'novaworks' ),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( 'E-Mail', 'novaworks' ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                'label'        => esc_html__( 'Use Additional Fields', 'novaworks' ),
        ...
        $repeater->add_control(
            'type',
            [
                'label'   => esc_html__( 'Field Type', 'novaworks' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'fname',
                'options' => [
                    'fname'   => esc_html__( 'First Name', 'novaworks' ),
                    'lname'   => esc_html__( 'Last Name', 'novaworks' ),
                    'address' => esc_html__( 'Address', 'novaworks' ),
                    'phone'   => esc_html__( 'Phone Number', 'novaworks' ),
                ]
            ]
        );
        ...
        $repeater->add_control(
            'placeholder',
            array(
                'label'   => esc_html__( 'Field Placeholder', 'novaworks' ),
                'type'    => Controls_Manager::TEXT,
                'default' => esc_html__( 'Enter Value', 'novaworks' ),
            )
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'type'        => 'fname',
                        'placeholder' => esc_html__( 'First Name', 'novaworks' ),
                    ],
                    [
                        'type'        => 'lname',
                        'placeholder' => esc_html__( 'Last Name', 'novaworks' ),
                    ],
                    [
                        'type'        => 'address',
                        'placeholder' => esc_html__( 'Address', 'novaworks' ),
                    ],
                    [
                        'type'        => 'phone',
                        'placeholder' => esc_html__( 'Phone Number', 'novaworks' ),
                    ],
                ],
        ...
        $this->add_control(
            'use_redirect_url',
            array(
                'label'        => esc_html__( 'Use Redirect Url?', 'novaworks' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'novaworks' ),
                'label_off'    => esc_html__( 'No', 'novaworks' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'redirect_url',
            array(
                'label'       => esc_html__( 'Redirect Url', 'novaworks' ),
                'type'        => Controls_Manager::TEXT,
                'placeholder' => esc_html__( 'Enter Redirect Url', 'novaworks' ),
                'default'     => '#',
                'condition'   => array(
        ...
        $this->add_control(
            'use_target_list_id',
            array(
                'label'        => esc_html__( 'Use Target List Id?', 'novaworks' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'novaworks' ),
                'label_off'    => esc_html__( 'No', 'novaworks' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
            'target_list_id',
            array(
                'label'     => esc_html__( 'Mailchimp list id', 'novaworks' ),
                'type'      => Controls_Manager::TEXT,
                'condition' => [
        ...
        $this->start_controls_tab(
            'tab_container_error',
            array(
                'label' => esc_html__( 'Error', 'novaworks' ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} ' . $css_scheme['instance'] . '.novaworks-subscribe-form--response-error' => 'background-color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'placeholder' => '1px',
                'default'     => '1px',
                'selector'    => '{{WRAPPER}} ' . $css_scheme['instance'] . '.novaworks-subscribe-form--response-error',
            )
        );
        ...
        $this->start_controls_section(
            'section_input_style',
            array(
                'label'      => esc_html__( 'Input', 'novaworks' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->start_controls_section(
            ...
            array(
                'label'      => esc_html__( 'Message', 'novaworks' ),
                'tab'        => Controls_Manager::TAB_STYLE,
                'show_label' => false,
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'selectors'  => array(
                    '{{WRAPPER}} ' . $css_scheme['message'] . ' .novaworks-subscribe-form__message-inner' => 'justify-content: {{VALUE}};',
                ),
            )
        );
        ...
        $this->start_controls_tab(
            'tab_message_success',
            array(
                'label' => esc_html__( 'Success', 'novaworks' ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .novaworks-subscribe-form--response-success ' . $css_scheme['message'] . ' span' => 'background-color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .novaworks-subscribe-form--response-success ' . $css_scheme['message'] . ' span' => 'color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'selector' => '{{WRAPPER}} .novaworks-subscribe-form--response-success ' . $css_scheme['message'] . ' span',
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%', 'em' ),
                'selectors'  => array(
                    '{{WRAPPER}} .novaworks-subscribe-form--response-success ' . $css_scheme['message'] . ' span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} .novaworks-subscribe-form--response-success ' . $css_scheme['message'] . ' span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} .novaworks-subscribe-form--response-success ' . $css_scheme['message'] . ' span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .novaworks-subscribe-form--response-error ' . $css_scheme['message'] . ' span' => 'background-color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_control(
            ...
            array(
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => array(
                    '{{WRAPPER}} .novaworks-subscribe-form--response-error ' . $css_scheme['message'] . ' span' => 'color: {{VALUE}}',
                ),
            )
        );
        ...
        $this->add_group_control(
            ...
            array(
                ...
                'selector' => '{{WRAPPER}} .novaworks-subscribe-form--response-error ' . $css_scheme['message'] . ' span',
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%', 'em' ),
                'selectors'  => array(
                    '{{WRAPPER}} .novaworks-subscribe-form--response-error ' . $css_scheme['message'] . ' span' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} .novaworks-subscribe-form--response-error ' . $css_scheme['message'] . ' span' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
        ...
        $this->add_responsive_control(
            ...
            array(
                ...
                'size_units' => array( 'px', '%' ),
                'selectors'  => array(
                    '{{WRAPPER}} .novaworks-subscribe-form--response-error ' . $css_scheme['message'] . ' span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ),
            )
        );
    ...
    public function generate_additional_fields() {
        ...
        $default_fields_data = [
            'fname' => [
                'class'       => [
                    'novaworks-subscribe-form__input novaworks-subscribe-form__fname-field',
                ],
                'type'        => 'text',
                'name'        => 'fname',
                'placeholder' => esc_html__( 'First Name', 'novaworks' ),
            ...
            'address' => [
                'class'       => [
                    'novaworks-subscribe-form__input novaworks-subscribe-form__address-field',
                ],
                'type'        => 'text',
                'name'        => 'address',
                'placeholder' => esc_html__( 'Address', 'novaworks' )
            ...
            'phone' => [
                'class'       => [
                    'novaworks-subscribe-form__input novaworks-subscribe-form__phone-field',
                ],
                'type'        => 'tel',
                'name'        => 'phone',
                'placeholder' => esc_html__( 'Phone Number', 'novaworks' )
