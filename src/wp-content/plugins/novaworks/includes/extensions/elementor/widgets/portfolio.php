...
class Portfolio extends NOVA_Widget_Base {
    ...
    public function render_filters() {
        ...
        echo sprintf( '<div class="isotope__filter novaworks-portfolio__filter js-el" data-nova_component="MasonryFilter" data-isotope_container="%2$s"><div class="isotope__filter-list novaworks-portfolio__filter-list">%1$s</div></div>', $html , '.elementor-element-'. $this->get_id().' .nova-isotope-container' );
