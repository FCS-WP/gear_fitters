...
class Products extends NOVA_Widget_Base {
    ...
    protected function _generate_carousel_setting_json(){
        ...
        $mobile_extra_col = absint( isset($settings['columns_mobile_extra']) ? $settings['columns_mobile_extra'] : 0 );
    ...
    protected function register_controls() {
        ...
        $masonry_style = apply_filters(
            'NovaworksElement/products/control/masonry_style',
            array(
                '1' => esc_html__( 'Type-1', 'novaworks' ),
                '2' => esc_html__( 'Type-2', 'novaworks' )
            )
        );
        $this->start_controls_section(
            'section_content',
    ...
    protected function _register_masonry_custom_layout(){
        ...
        $repeater->add_control(
            'item_disable_border_right',
            array(
                'label'        => esc_html__( 'Disable Border Right', 'novaworks' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'novaworks' ),
                'label_off'    => esc_html__( 'No', 'novaworks' ),
                'return_value' => 'true',
        ...
        $repeater->add_control(
            'item_disable_border_bottom',
            array(
                'label'        => esc_html__( 'Disable Border Bottom', 'novaworks' ),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Yes', 'novaworks' ),
                'label_off'    => esc_html__( 'No', 'novaworks' ),
                'return_value' => 'true',
        ...
        $this->start_controls_section(
            'section_masonry',
            array(
                'label' => esc_html__( 'Masonry Setting', 'novaworks' ),
                'condition' => [
                    'layout' => 'masonry'
                ]
            )
        ...
        $this->add_control(
            ...
            array(
                ...
                'default'     => array(
                  array(
                      'item_title'  => esc_html__( 'Size 2x2', 'novaworks' ),
                      'item_width'  => 2,
                      'item_height'  => 2,
                      'item_disable_border_right' => 'true'
                  ),
                    array(
                        'item_title'  => esc_html__( 'Size 1x1', 'novaworks' ),
                        'item_width'  => 1,
                        'item_height'  => 1,
                        'item_disable_border_right' => 'true',
                        'item_disable_border_bottom' => 'true'
                    ),
                    array(
                        'item_title'  => esc_html__( 'Size 1x1', 'novaworks' ),
                        'item_width'  => 1,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Heading', 'novaworks' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
